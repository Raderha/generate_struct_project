...
CREATE TABLE `projects` (
  ...
  CONSTRAINT `projects_ibfk_2` FOREIGN KEY (`template_id`) REFERENCES `templates` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `templates` (
  ...
  `description` text,
  `type` enum('public','private','custom') DEFAULT 'custom',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
...
-- Dump completed on 2025-05-06 19:47:55
